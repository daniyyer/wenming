  ...
  void 0 !== ko &&
    ...
    (Multiselect.prototype = {
      defaults: {
        buttonText: function (options, select) {
          if (
            ...
            (select.prop("disabled") || (0 == options.length && this.disableIfEmpty))
          )
          ...
          if (
            ...
            return this.selectAllNumber
              ...
              : this.allSelectedText;
          if (0 != this.numberDisplayed && options.length > this.numberDisplayed)
            ...
            $.proxy(function (event) {
              ...
              if (event.shiftKey && this.options.multiple) {
                $target.is("input") ||
                  ...
                  ($target = $target.closest(".multiselect-option").find("input")).prop(
                    "checked",
                    !$target.prop("checked"),
                  ));
                ...
                if (
                  ...
                  groupItem.hasClass("multiselect-group") ||
                    ...
                    ($checkbox = groupItem.find(".form-check-input")).length > 0 &&
                      ($checkbox.prop("checked", !$checkbox.prop("checked")), $checkbox.change());
                }
                event.preventDefault();
              }
      ...
      createCheckbox: function ($item, label, name, value, title, inputType) {
        var $wrapper = $("<span />");
        if (($wrapper.addClass("form-check"), this.options.enableHTML && $(label).length > 0))
      ...
      createOptgroup: function (group) {
        ...
        if (this.options.enableClickableOptGroups && this.options.multiple) {
          ...
          this.options.enableHTML ? $groupOption.html(" " + label) : $groupOption.text(" " + label);
                              ...
                              $.proxy(function (index, element) {
                                ...
                                if (
                                  ...
                                  if (
                                    ...
                                    filterCandidate.indexOf(this.query) > -1 && (showElement = !0);
                                  showElement ||
      ...
      rebuild: function () {
        this.$popupContainer.html(""),
          ...
          this.updateSelectAll(!0),
          this.options.enableClickableOptGroups && this.options.multiple && this.updateOptGroups(),
          this.options.disableIfEmpty && $("option", this.$select).length <= 0
            ? this.disable()
            : this.enable(),
          this.options.dropRight
            ? this.$container.addClass("dropright")
      ...
      updateOptGroups: function () {
        ...
        $groups.each(function () {
          ...
          $options.each(function () {
            ...
            selectedClass &&
              (checked ? $(this).addClass(selectedClass) : $(this).removeClass(selectedClass)),
      ...
      getOptionByValue: function (value) {
        for (
          var options = $("option", this.$select), valueToCompare = value.toString(), i = 0;
          i < options.length;
          i += 1
        ) {
