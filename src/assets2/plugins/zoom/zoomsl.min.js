  ...
  e.extend(y, {
    ...
    H: function (d) {
      ...
      if (a) {
        ...
        a.K.css({
          ...
          top:
            a.f.d > b
              ? Math.min(a.f.d - b, Math.max(0, c.a.A - b / 2)) + e.top - a.w.t.R
              : e.top - a.w.t.R,
        });
        a.c.innerzoommagnifier &&
          ((c.a.p += (c.a.g - c.a.p) / a.c.loopspeedanimate),
          (c.a.q += (c.a.i - c.a.q) / a.c.loopspeedanimate),
          a.l.css({ left: c.a.p - Math.round(a.e.b / 2), top: c.a.q - Math.round(a.e.d / 2) }),
    ...
    P: function (d) {
      ...
      var p = a.c.magnifiersize[1],
        ...
        b = 0;
      s =
        l.left + ("left" === a.c.magnifierpos ? -a.e.b - a.c.leftoffset : a.f.b + a.c.rightoffset);
      a.c.switchsides &&
        !a.c.innerzoom &&
      ...
      a.c.innerzoommagnifier &&
        ((h = this.a.g - Math.round(a.e.b / 2)), (b = this.a.i - Math.round(a.e.d / 2)));
      c = function () {
      ...
      switch (a.c.magnifiereffectanimate) {
        ...
        case "showIn":
          a.l
            ...
            .css({ opacity: "0.1" })
            .animate(
              { left: h, top: b, opacity: "1", width: d, height: p },
      ...
      if (0 === m.d || 0 === m.b)
        ...
        b.descarea && e(b.descarea).length
          ? 0 === e(b.descarea).width() || 0 === e(b.descarea).height()
            ? (b.descarea = r)
            : (b.magnifiersize = [e(b.descarea).width(), e(b.descarea).height()])
          : (b.descarea = r);
        b.innerzoom &&
        ...
        C &&
          (t
            ...
            .css({ position: "absolute", zIndex: x, left: 0, top: 0, display: "none" })
            .html(C)
            .appendTo(document.body),
          c.classtextdn ||
            t.css({
        ...
        e(document).mousemove(function (a) {
          f.a.D = a.pageX;
          f.a.g !== f.a.D &&
            (clearTimeout(f.a.n), clearTimeout(f.a.o), d.css({ visibility: "visible" }));
        });
        ...
        g.one("mouseover", function () {
          ...
          h.bind("loadevt", function (a, e) {
            if ("error" !== e.type) {
              ...
              s(h);
              p.g == f.a.D &&
                (q.fadeIn(), f.P(g), clearTimeout(f.a.n), clearTimeout(f.a.o), f.H(g), f.I(g));
              var l = g.data("specs");
              h.css({
