QUnit.test(
  "Testing moveSectionUp first section active with slides {css3:true, autoScrolling:true}",
  function (assert) {
    var id = "#fullpage";
...
QUnit.test(
  "Testing moveSectionUp first section active with slides {css3:false, autoScrolling:true}",
  function (assert) {
    var id = "#fullpage";
...
QUnit.test(
  "Testing moveSectionUp in fullpage-last-section-active {css3:true, autoScrolling:true}",
  function (assert) {
...
QUnit.test(
  "Testing moveSectionUp in fullpage-last-section-active {css3:false, autoScrolling:true}",
  function (assert) {
    var id = "#fullpage-last-section-active";
