...
QUnit.test("Testing onSlideLeave callback fullpage-moveSlideRight", function (assert) {
  ...
  var FP = initFullpageNew(
    id,
    Object.assign({}, sectionsAndSlidesCallbacks, { scrollingSpeed: 50, v2compatible: true }),
  );
  ...
  function afterMove(i) {
    ...
    assert.equal(
      onSlideLeave,
      "null, 1, " + i + ", right, " + (i + 1) + "",
      "We expect the right values for the callback",
    );
    done();
  }
});
...
QUnit.test("Testing onSlideLeave callback fullpage-moveSlideRight with anchors", function (assert) {
  ...
  var FP = initFullpageNew(
    id,
    Object.assign({ scrollingSpeed: 50 }, allBasicOptions, sectionsAndSlidesCallbacks, {
      v2compatible: true,
    }),
  );
  var done = assert.async(3);
...
QUnit.test("Testing onSlideLeave from last slide to first with loopHorizontal", function (assert) {
  ...
  var FP = initFullpageNew(
    id,
    Object.assign({ scrollingSpeed: 50 }, sectionsAndSlidesCallbacks, {
      loopHorizontal: true,
      v2compatible: true,
    }),
  );
...
QUnit.test("Testing onSlideLeave from 1st slide to last", function (assert) {
  ...
  var FP = initFullpageNew(
    id,
    Object.assign({}, sectionsAndSlidesCallbacks, { loopHorizontal: true, v2compatible: true }),
  );
...
QUnit.test(
  "Testing afterSlideLoad callback with active 2nd section and 1st slide active",
  function (assert) {
...
//section is active by default. But... Probably it should...
QUnit.test(
  "Testing afterSlideLoad callback with active 2nd section and middle slide active",
  function (assert) {
...
//section is active by default. But... Probably it should...
QUnit.test(
  "Testing afterSlideLoad callback with active 2nd section and single slide active",
  function (assert) {
...
QUnit.test(
  "Testing afterRender callback on fullpage-middle-slide-active-in-2nd-active-section",
  function (assert) {
    var id = "#fullpage-2nd-active-section";
    var FP = initFullpageNew(
      id,
...
QUnit.test(
  "Testing afterRender callback on fullpage-first-slide-active-in-2nd-active-section",
  function (assert) {
    var id = "#fullpage-first-slide-active-in-2nd-active-section";
    var FP = initFullpageNew(
      id,
...
QUnit.test(
  "Testing afterRender callback on fullpage-sigle-slide-active-in-2nd-active-section",
  function (assert) {
...
QUnit.test("Testing afterLoad when autoScrolling:false on scroll with section", function (assert) {
  ...
  var FP = initFullpageNew(
    id,
    Object.assign({}, sectionsAndSlidesCallbacks, {
      scrollingSpeed: 50,
      autoScrolling: false,
      v2compatible: true,
    }),
...
QUnit.test(
  "Testing afterLoad when autoScrolling:false on scroll with section and anchors",
  function (assert) {
    var id = "#fullpage-sections-and-slides-with-data-anchor";
    var done = assert.async(1);
    var FP = initFullpageNew(
...
QUnit.test("Testing afterLoad callback with fullpage-first-slide-active-in-2nd-section", function (
  assert,
) {
...
QUnit.test("Testing afterLoad callback with fullpage-middle-slide-active-in-2nd-section", function (
  assert,
) {
...
QUnit.test("Testing afterResponsive", function (assert) {
  ...
  assert.equal(
    afterResponsive,
    true,
    "We expect afterResponsive callback to be fired with true value",
  );
  ...
  assert.equal(
    afterResponsive,
    false,
    "We expect afterResponsive callback to be fired with false value",
  );
});
