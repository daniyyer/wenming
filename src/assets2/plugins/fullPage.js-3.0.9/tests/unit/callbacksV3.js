...
QUnit.test("Testing onSlideLeave callback v3 fullpage-moveSlideRight", function (assert) {
  ...
  var FP = initFullpageNew(
    id,
    Object.assign({}, sectionsAndSlidesCallbacksV3, { v2compatible: false, scrollingSpeed: 50 }),
  );
  ...
  function afterMove(i) {
    ...
    assert.equal(
      onSlideLeave.origin.anchor,
      "slide" + (i + 1),
      "We expect origin anchor to be correct",
    );

    assert.equal(
      onSlideLeave.destination.index,
      i + 1,
      "We expect destination index to be correct",
    );
    assert.equal(
      onSlideLeave.destination.anchor,
      "slide" + (i + 2),
      "We expect destination anchor to be correct",
    );
    assert.equal(
      onSlideLeave.destination.isLast,
      i === 2,
      "We expect destination isLast to be correct",
    );
    assert.equal(
      onSlideLeave.destination.isFirst,
      false,
      "We expect destination isFirst to be correct",
    );
...
QUnit.test("Testing onSlideLeave callback v3 fullpage-moveSlideRight with anchors", function (
  assert,
) {
  var id = "#fullpage-moveSlideRight";
  var FP = initFullpageNew(
    id,
    Object.assign({ scrollingSpeed: 50 }, allBasicOptionsV3, sectionsAndSlidesCallbacksV3, {
      v2compatible: false,
    }),
  );
  var done = assert.async(3);
...
QUnit.test("Testing onSlideLeave v3 from last slide to first with loopHorizontal", function (
  assert,
) {
  var id = "#fullpage-moveSlideLeft";
  var FP = initFullpageNew(
    id,
    Object.assign({ scrollingSpeed: 50 }, sectionsAndSlidesCallbacksV3, { loopHorizontal: true }),
  );
...
QUnit.test("Testing onSlideLeave v3 from 1st slide to last", function (assert) {
  ...
  var FP = initFullpageNew(
    id,
    Object.assign({}, sectionsAndSlidesCallbacksV3, { loopHorizontal: true }),
  );
...
QUnit.test("Testing afterSlideLoad callback v3", function (assert) {
  ...
  var FP = initFullpageNew(
    id,
    Object.assign({}, sectionsAndSlidesCallbacksV3, { scrollingSpeed: 50 }),
  );
  ...
  setTimeout(function () {
    ...
    assert.equal(
      afterSlideLoad.destination.anchor,
      "slide2",
      "We expect destination anchor to be correct",
    );
    assert.equal(
      afterSlideLoad.destination.isFirst,
      false,
      "We expect destination isFirst to be correct",
    );
    assert.equal(
      afterSlideLoad.destination.isLast,
      false,
      "We expect destination isLast to be correct",
    );
...
QUnit.test(
  "Testing afterSlideLoad callback v3 with active 2nd section and 1st slide active",
  function (assert) {
...
//section is active by default. But... Probably it should...
QUnit.test(
  "Testing afterSlideLoad callback v3 with active 2nd section and middle slide active",
  function (assert) {
...
//section is active by default. But... Probably it should...
QUnit.test(
  "Testing afterSlideLoad callback v3 with active 2nd section and single slide active",
  function (assert) {
...
QUnit.test(
  "Testing afterRender callback v3 on fullpage-middle-slide-active-in-2nd-active-section",
  function (assert) {
    var id = "#fullpage-2nd-active-section";
    var FP = initFullpageNew(
      id,
...
QUnit.test(
  "Testing afterRender callback v3 on fullpage-first-slide-active-in-2nd-active-section",
  function (assert) {
    var id = "#fullpage-first-slide-active-in-2nd-active-section";
    var FP = initFullpageNew(
      id,
...
QUnit.test(
  "Testing afterRender callback v3 on fullpage-sigle-slide-active-in-2nd-active-section",
  function (assert) {
...
QUnit.test("Testing afterLoad v3 when autoScrolling:false with section", function (assert) {
  ...
  var FP = initFullpageNew(
    id,
    Object.assign({}, sectionsAndSlidesCallbacksV3, { scrollingSpeed: 50, autoScrolling: false }),
  );
...
QUnit.test(
  'Testing afterLoad v3 when autoScrollingkey: "value", false with section and anchors',
  function (assert) {
    var id = "#fullpage-sections-and-slides-with-data-anchor";
    var done = assert.async(1);
    var FP = initFullpageNew(
...
QUnit.test(
  "Testing afterLoad callback v3 with fullpage-first-slide-active-in-2nd-section",
  function (assert) {
...
QUnit.test(
  "Testing afterLoad callback v3 with fullpage-middle-slide-active-in-2nd-section",
  function (assert) {
...
QUnit.test("Testing afterResize", function (assert) {
  ...
  setTimeout(function () {
    assert.equal(
      ...
      "We expect afterResize to get fired with some delay",
    );
    done();
  }, 450);
});
