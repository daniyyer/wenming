...
QUnit.test(
  "Testing setAutoScrolling(false, external) {autoScrolling:false, fitToSection:false}",
  function (assert) {
    var id = "#fullpage-2nd-active-section";
...
QUnit.test(
  "Testing setAutoScrolling(false, external) {autoScrolling:false, fitToSection:true}",
  function (assert) {
    var id = "#fullpage-2nd-active-section";
