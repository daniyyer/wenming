...
QUnit.test('Testing normalScrollElements: ".normalScroll" - scrolling inside it', function (
  assert,
) {
  var id = "#fullpage-normalscrollelements";
...
QUnit.test('Testing normalScrollElements: ".normalScroll" - scrolling outside it', function (
  assert,
) {
  var id = "#fullpage-normalscrollelements";
  var FP = initFullpageNew(id, { autoScrolling: true, normalScrollElements: ".normalscroll" });
...
QUnit.test(
  "Testing normalScrollElements on dynamically added elements - scrolling inside it",
  function (assert) {
    var id = "#fullpage";
    var FP = initFullpageNew(id, { autoScrolling: true, normalScrollElements: ".normalscroll" });
...
QUnit.test(
  "Testing normalScrollElements on dynamically added element - scrolling outside it",
  function (assert) {
    var id = "#fullpage";
    var FP = initFullpageNew(id, { autoScrolling: true, normalScrollElements: ".normalscroll" });
    var windowHeight = $(window).height();
