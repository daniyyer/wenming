...
!(function (e, t, n, o, r) {
  ...
  function In(e, t) {
    e = i(e) ? e[0] : e;
    for (
      var n = null != t ? yn(t, e.parentNode) : e.parentNode.childNodes, o = 0, r = 0;
      r < n.length;
      r++
    ) {
      if (n[r] == e) return o;
  ...
  return (
    ...
    function (e, E) {
      ...
      function be(e, t, n) {
        ...
        var c = yn(an, e)[0];
        null != c && (0 !== In(yn(Qt), qt) || (0 === In(yn(Qt), qt) && 0 !== In(c)))
          ? At(c, "internal")
          : Nn(t[0], Xt);
      }
      function ye(e, t, n) {
      ...
      function Re(e, t, n) {
        if (null != e) {
          ...
          if (!((d.activeSection == e && !T) || (E.scrollBar && Un() === d.dtop && !Ln(e, Zt)))) {
            if (
              (null != d.activeSlide &&
                ((u = d.activeSlide.getAttribute("data-anchor")), (f = In(d.activeSlide))),
              !d.localIsResizing)
            ) {
              var v = d.yMovement;
              if (
      ...
      function rt(e) {
        E.autoScrolling &&
          (k && (e.pageY < G && p.m.up ? ae() : e.pageY > G && p.m.down && se()), (G = e.pageY));
      }
      function it(e, t, n) {
        var o,
          r,
        ...
        (l.xMovement =
          ((o = l.prevSlideIndex), (r = l.slideIndex), o == r ? "none" : r < o ? "left" : "right")),
          ...
          !1 === Ne("onSlideLeave", l)
            ...
            : (Nn(t, Xt),
              ...
              !E.loopHorizontal &&
                E.controlArrows &&
                (Qn(yn(Sn, i), 0 !== l.slideIndex), Qn(yn(wn, i), null != Cn(t))),
              Ln(i, Xt) &&
                !l.localIsResizing &&
      ...
      function lt(e) {
        ...
        (t = e.slidesNav),
          ...
          e.localIsResizing ||
            (_n(E.afterSlideLoad) && Ne("afterSlideLoad", e), (k = !0), Ue(e.destiny)),
          (a = !1);
      }
      function at() {
        (T = !0),
      ...
      function dt(e, t) {
        ...
        (n = e),
          yn(E.menu).forEach(function (e) {
            E.menu &&
              null != e &&
              (zn(yn(Kt, e), Xt), Nn(yn('[data-menuanchor="' + n + '"]', e), Xt));
          }),
          (o = e),
          (r = t),
          E.navigation &&
      ...
      function bt(e, t, n, o) {
        ...
        E.anchors.length &&
          !E.lockAnchors &&
          (e
            ? (null != n && (r = n), null == t && (t = e), yt(r + "/" + (i = t)))
            : (null != e && (i = t), yt(n))),
          Lt();
      }
      function yt(e) {
