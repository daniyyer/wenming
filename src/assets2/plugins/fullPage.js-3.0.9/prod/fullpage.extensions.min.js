...
!(function (e, t, n, o, r) {
  ...
  function no(e, t) {
    e = io(e) ? e[0] : e;
    for (
      var n = null != t ? Gn(t, e.parentNode) : e.parentNode.childNodes, o = 0, r = 0;
      r < n.length;
      r++
    ) {
      if (n[r] == e) return o;
  ...
  function o(e, t, n) {
    ...
    for (var r = 0; r < e.length; r++) {
      var i = e[r];
      ((n && !r) || !n) && ((o = t.cloneNode(!0)), i.parentNode.insertBefore(o, i)),
        o.appendChild(i);
    }
    return e;
  }
  ...
  return (
    ...
    function (e, g) {
            ...
            (S.destroy = function (e) {
              wo(w, "destroy", e),
                ...
                e &&
                  ...
                  Ao(Gn(Tn + ", " + Pn + ", " + Dn)),
                  Jn(Gn(wn), { height: "", "background-color": "", padding: "" }),
                  Jn(Gn(Cn), { width: "" }),
                  Jn(w, { height: "", position: "", "-ms-touch-action": "", "touch-action": "" }),
      ...
      function Me(e, t, n) {
        ...
        var c = Gn(Hn, e)[0];
        null != c && (0 !== no(Gn(yn), wn) || (0 === no(Gn(yn), wn) && 0 !== no(c)))
      ...
      function Oe(e, t) {
        t || null != Gn(yn)[0] || lo(e, gn),
          ...
          void 0 !== g.sectionsColor[t] && Jn(e, { "background-color": g.sectionsColor[t] }),
      ...
      function He() {
        ...
        if ((wo(w, "onScroll"), (!g.autoScrolling || g.scrollBar || _t("dragAndMove")) && !$t())) {
          var t = _t("dragAndMove") ? Math.abs(S.dragAndMove.getCurrentScroll()) : go(),
            ...
            o = t + Qn() / 2,
            r =
              (_t("dragAndMove") ? S.dragAndMove.getDocumentHeight() : m.offsetHeight - Qn()) === t,
            i = Gn(wn);
          if (r) n = i.length - 1;
          ...
          if (!Un((e = i[n]), gn)) {
            ...
            p && ((s = p.getAttribute("data-anchor")), (a = no(p))),
              x &&
                ...
                _t("resetSliders") &&
                  S.resetSliders.apply({ localIsResizing: E, leavingSection: u }),
                tt(c),
                Ke(e),
                qe(e),
                kt(d, v - 1),
      ...
      function Ie(e) {
        if (v.m[e]) {
          var t = "down" === e ? ve : de;
          if (
            (_t("scrollHorizontally") && (t = S.scrollHorizontally.getScrollSection(e, t)),
            g.scrollOverflow)
          ) {
      ...
      function Ve(e) {
        ...
        return (
          y < t ? ((r || l) && "bottom" !== l) || (o = i) : (r || (E && null == eo(e))) && (o = i),
          g.offsetSections &&
            S.offsetSections &&
      ...
      function Ze(e, t, n) {
        if (null != e) {
          ...
          if (!((i.activeSection == e && !E) || (g.scrollBar && go() === i.dtop && !Un(e, An)))) {
            if (
              (null != i.activeSlide &&
                ((o = i.activeSlide.getAttribute("data-anchor")), (r = no(i.activeSlide))),
              !i.localIsResizing)
            ) {
              var l = i.yMovement;
              if (
        ...
        var n,
          ...
          l =
            ...
            (i = g.v2compatible
              ...
              : {
                  afterRender: function () {
                    return { section: Ge(Gn(yn)[0]), slide: Fe(Gn(Hn, Gn(yn)[0])[0]) };
                  },
                  onLeave: function () {
                    return {
      ...
      function at(e) {
        if (
          ...
          "MutationObserver" in an &&
            new MutationObserver(it).observe(sn.body, { childList: !0, subtree: !1 }),
          (!B || (_t(e) && S[e])) && (!rt(e) || !B))
        ) {
          st();
      ...
      function dt(e) {
        ...
        9 === n
          ? (function (e) {
              ...
              (a = Ge(vo(i, wn))),
              l || a) &&
                (c ? null == vo(c, yn + "," + yn + " " + Hn) && (c = f(e)) : f(e),
      ...
      function bt(e) {
        g.autoScrolling &&
          (x && (e.pageY < ne && v.m.up ? de() : e.pageY > ne && v.m.down && ve()), (ne = e.pageY));
      }
      function wt(e, t, n) {
        var o = vo(e, wn),
          r = {
        ...
        (r.xMovement = Ht(r.prevSlideIndex, r.slideIndex)),
          ...
          !1 === Xe("onSlideLeave", r)
            ...
            : (lo(t, gn),
              ...
              g.interlockedSlides &&
                S.interlockedSlides &&
                ((_t("continuousHorizontal") && void 0 !== n && n !== r.xMovement) ||
                  S.interlockedSlides.apply(r)));
      }
      function yt(e) {
        !g.loopHorizontal &&
          g.controlArrows &&
          (Eo(Gn(Vn, e.section), 0 !== e.slideIndex), Eo(Gn(Zn, e.section), null != eo(e.destiny)));
      }
      function Et(e) {
        var t, n;
        S.continuousHorizontal && S.continuousHorizontal.afterSlideLoads(e),
          (t = e.slidesNav),
          (n = e.slideIndex),
          g.slidesNavigation && null != t && (ao(Gn(mn, t), gn), lo(Gn("a", Gn("li", t)[n]), gn)),
          e.localIsResizing ||
      ...
      function kt(e, t) {
        ...
        (n = e),
          Gn(g.menu).forEach(function (e) {
            g.menu &&
              null != e &&
              (ao(Gn(mn, e), gn), lo(Gn('[data-menuanchor="' + n + '"]', e), gn));
          }),
          (o = e),
          (r = t),
          (i = Gn(Tn)[0]),
      ...
      function Nt(e, t) {
        ...
        if (null != n) {
          var o,
            ...
            i,
            l =
              (null == (i = Gn(Cn + '[data-anchor="' + (o = t) + '"]', (r = n))[0]) &&
      ...
      function Pt(e, t, n, o) {
        ...
        g.anchors.length &&
          !g.lockAnchors &&
          (e
            ? (null != n && (r = n), null == t && (t = e), Wt(r + "/" + (i = t)))
            : (null != e && (i = t), Wt(n))),
          Yt();
      }
      function Wt(e) {
      ...
      function _t(e) {
        return null !== g[e] && "[object Array]" === Object.prototype.toString.call(g[e])
          ? g[e].length && S[e]
          : g[e] && S[e];
      }
      function Jt(e, t, n) {
              ...
              g.anchors.forEach(function (t) {
                var e = [].slice.call(Gn("[name]")).filter(function (e) {
                  ...
                  n = [].slice.call(Gn("[id]")).filter(function (e) {
                    return (
                      e.getAttribute("id") && e.getAttribute("id").toLowerCase() == t.toLowerCase()
                    );
                  });
                if (n.length || e.length) {
                  ...
                  (n.length || e.length) &&
                    Xn(
                      "error",
                      '"' + t + '" is is being used by another element `' + o + "` property",
                    );
                }
              }));
      }
