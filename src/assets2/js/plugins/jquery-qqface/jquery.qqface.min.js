!(function (e) {
  ...
  function (e, t, n) {
    !(function () {
      ...
      $.extend({
        qqface: function (n) {
          var a = { before: function () {}, after: function () {} };
          n = $.extend({}, a, n);
    ...
    function o(e) {
      for (var t = [], n = {}, i = 0; i < e.length; i++) {
        var o = e[i],
          ...
          u = o[2],
          s = o[3],
          f = { css: r, media: u, sourceMap: s };
        n[a] ? n[a].parts.push(f) : t.push((n[a] = { id: a, parts: [f] }));
      }
      return t;
    }
    function a(e, t) {
  ...
  function (e, t) {
    e.exports = function (e, t) {
      ...
      (i = r + t.outerHeight() < c ? r + s : r - t.outerHeight()), t.css({ left: n, top: i });
    };
  },
  function (e, t) {
    e.exports = function (e, t) {
