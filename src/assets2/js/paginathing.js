...
(function ($, window, document) {
  ...
  Paginator.prototype = {
    pagination: function (type, page) {
      ...
      var cssClass = type === "number" ? _self.options.liClass : _self.options.liClass + " " + type;
      var text = "";
      if (type === "number") {
        text = page;
    ...
    render: function (page) {
      ...
      } else if (options.appendToContainer) {
        _self.container.append(_self.ul);
        $(options.appendToContainer).append(_self.container);
      } else {
